...
all_depths = concatenate_and_save('depths', 'prj_03_train_val_depths.pkl')
all_depths_next = concatenate_and_save('depths_next', 'prj_03_train_val_depths_next.pkl')
all_terrains = concatenate_and_save('terrains', 'prj_03_train_val_terrains.pkl')
