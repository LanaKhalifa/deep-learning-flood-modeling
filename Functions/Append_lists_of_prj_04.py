...
def concatenate_and_save(file_prefix, output_filename):
    ...
    for i in range(4):  # leave last index for test set
...
all_depths = concatenate_and_save('depths', 'all_depths.pkl')
all_depths_next = concatenate_and_save('depths_next', 'all_depths_next.pkl')
all_terrains = concatenate_and_save('terrains', 'all_terrains.pkl')
