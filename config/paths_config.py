...
# Data directories
SIMULATIONS_ROOT = PROJECT_ROOT / 'simulations_to_samples'
RAW_DATA_DIR = SIMULATIONS_ROOT / 'raw_data'
PROCESSED_DATA_DIR = SIMULATIONS_ROOT / 'processed_data'
...
TRAINING_ROOT = PROJECT_ROOT / 'multi_architecture_training'
MODELS_DIR = TRAINING_ROOT / 'models'
TRAINING_UTILS_DIR = TRAINING_ROOT / 'training_utils'

# Stage-specific directories
STAGE_A_DIR = TRAINING_ROOT / 'A_train_all_archs_on_small_set'
STAGE_B_DIR = TRAINING_ROOT / 'B_tune_one_arch_on_small_set'
STAGE_C_DIR = TRAINING_ROOT / 'C_train_best_four_on_big_set'

# Evaluation and Visualization directories
EVAL_VIS_ROOT = PROJECT_ROOT / 'evaluate_and_visualize_best_model'
RAE_BOXPLOTS_DIR = EVAL_VIS_ROOT / 'boxplots'
VISUALIZATION_DIR = EVAL_VIS_ROOT / 'visualizations'

# Stage-specific results directories (decentralized)
...
# Full domain closure
FULL_DOMAIN_DIR = PROJECT_ROOT / 'full_domain_closure_best_model'
