...
**python main.generate_patches:** takes each simulation (210 in total) terrain and water depth maps and generates patches save to:
...
**python main.generate_datasets**:loads the extracted patches and assembles them into datasets  according to the logic below. it saves them in:
