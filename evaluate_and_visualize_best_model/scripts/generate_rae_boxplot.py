...
def calculate_and_save_all_raes(device, arch_name='arch_05'):
...
def plot_rae_boxplots_arch_05(device):
    ...
    ax.set_title(f'RAE Distribution Across Datasets - ClassicUNet', fontsize=18)
...
def main():
    ...
    plot_rae_boxplots(device, 'arch_05')
